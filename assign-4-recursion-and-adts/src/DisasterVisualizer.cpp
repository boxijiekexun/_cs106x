...
void drawCities(const Geometry& geo,
    ...
    for (const string& city: network.network) {
        ...
        /* Outer "ring" */
        GOval *oval = new GOval(center.x - kCityOuterRadius,
                                center.y - kCityOuterRadius,
        ...
        /* Inner "circle" */
        oval = new GOval(center.x - kCityInnerRadius,
                         center.y - kCityInnerRadius,
...
void drawCityLabels(const Geometry& geo,
    ...
    for (const string& city: network.network) {
        ...
        theWindow()->add(label,
                         center.x - label->getWidth() / 2.0,
                         center.y + label->getFontAscent() / 2.0);
